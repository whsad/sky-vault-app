...
import com.computer.skyvault.databinding.ItemNavDividerBinding
import com.computer.skyvault.databinding.ItemNavMenuBinding
...
class NavMenuAdapter(
    ...
    inner class MenuViewHolder(binding: ItemNavMenuBinding) : RecyclerView.ViewHolder(binding.root) {
...
//                itemLayout.setBackgroundColor(R.color.md_theme_secondaryContainer)
                itemLayout.setBackgroundResource(R.color.md_theme_secondaryContainer)
    ...
    inner class DividerViewHolder(binding: ItemNavDividerBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            NavItem.TYPE_MENU -> {
                val binding = ItemNavMenuBinding.inflate(LayoutInflater.from(parent.context), parent, false)
                MenuViewHolder(binding)
            }

            NavItem.TYPE_DIVIDER -> {
                val binding = ItemNavDividerBinding.inflate(LayoutInflater.from(parent.context), parent, false)
