...
import com.computer.skyvault.databinding.StarredFragmentBinding

class StarredFragment : Fragment() {

    private var _binding: StarredFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = StarredFragmentBinding.inflate(inflater, container, false)
